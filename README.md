...
Yêu cầu **bắt buộc**
* [ ] Đăng ký tài khoản bằng email, password, và tên.  (**1412067**)
* [ ] Đăng nhập bằng email và password. (**1412067**)
* [ ] Sau khi đăng nhập, người dùng sẽ được chuyển đến trang liệt kê danh sách các tin nhắn đã nhận, sắp xếp theo thứ tự thời gian, một nút để tạo tin nhắn mới, nút để xem danh sách bạn bè và nút để xem các tin nhắn đã gửi. (**1412067**)
